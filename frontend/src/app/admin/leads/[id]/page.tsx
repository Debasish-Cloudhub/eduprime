...
import { ArrowLeft, Lock, IndianRupee, MessageSquare, ChevronRight } from 'lucide-react';
      ...
      <div className="flex-1 p-6 max-w-6xl mx-auto w-full">
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-3">
            <Link href="/admin/leads" className="p-2 rounded-lg hover:bg-gray-100"><ArrowLeft size={18}/></Link>
            <div>
